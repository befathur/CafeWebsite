	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-10 col-right p-5 pt-5 pb-3">
				...
				<p class="title mt-3">Edit Produk</p>
				@if($errors)
					<ul>
					...
					<div class="row">
						<div class="col-md-4">
							...
							<div class="mb-3">
								...
								<input type="number" name="stok" value="{{$product->stok}}" class="form-control form-stok" min="0">
							</div>
							<div class="mb-3">
								<label for="tanggal-beli" class="form-label">Tanggal Beli</label>
								<input type="date" name="tgl_beli" value="{{$product->tgl_beli}}" class="form-control">
							</div>
							<div class="mb-3">
								<label for="tanggal-beli" class="form-label">Tanggal Kadaluwarsa</label>
								<input type="date" name="tgl_kadaluwarsa" value="{{$product->tgl_kadaluwarsa}}" class="form-control">
							</div>
						</div>
						<div class="col-md-4">
							<div class="mb-3">
							...
							<div class="mb-3">
								...
								<input type="text" name="fotos" value="{{$product->foto}}" class="form-control" hidden>
							</div>
							<div class="mb-3">
								<label for="deskripsi" class="form-label">Deskripsi Produk</label>
								<textarea class="form-control" rows="9" name="deskripsi">{{$product->deskripsi}}</textarea>
							</div>
